...
if (ACLController::checkAccess('DM_VehiclesInventory', 'edit', true)) {
    $module_menu[] = array(
        "index.php?module=DM_VehiclesInventory&action=EditView&return_module=DM_VehiclesInventory&return_action=index", 
...
if (ACLController::checkAccess('DM_VehiclesInventory', 'list', true)) {
    $module_menu[] = array(
        "index.php?module=DM_VehiclesInventory&action=index&return_module=DM_VehiclesInventory&return_action=DetailView", 
...
if (ACLController::checkAccess('DM_VehiclesInventory', 'import', true)) {
    $module_menu[] = array(
        "index.php?module=Import&action=Step1&import_module=DM_VehiclesInventory&return_module=DM_VehiclesInventory&return_action=index", 
...
if (ACLController::checkAccess('DM_VehiclesInventory', 'list', true)) {
    $module_menu[] = array(
        "index.php?module=DM_VehiclesInventory&action=index&query=true&status=Available", 
...
if (ACLController::checkAccess('DM_VehiclesInventory', 'list', true)) {
    $module_menu[] = array(
        "index.php?module=DM_VehiclesInventory&action=index&query=true&days_on_lot_range_min=30", 
...
if (ACLController::checkAccess('DM_VehiclesInventory', 'list', true)) {
    $module_menu[] = array(
        "index.php?module=DM_VehiclesInventory&action=index&query=true&date_entered_range=last_7_days", 
